    ...
    <>
      ...
      <div className="rf-controls" aria-label="품질시험 자료 선택">
        <button
          ...
          aria-pressed={draft.workspace !== "user"}
          ...
          <section className="rf-card">
            ...
            >
                  ...
                  <strong>
                    {isDcpt
                      ...
                      : Math.max(
                          ...rows.map(
                            (r) =>
                              (dataset.id === "plate" ? r.pressure : r.load) ||
                              0,
                          ),
                        ).toFixed(2)}
                    <small>
              ...
              {dataset.id === "plate" && draft.view === "time" && (
                <p className="rf-note">
                  전체 경과시간은 하중단계 연결용입니다. 원문에 기록된 시험
                  시각이 아닙니다.
                </p>
              )}
